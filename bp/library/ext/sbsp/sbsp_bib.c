...
#endif
	//asb->ciphersuiteFlags = 0;	/* ETRI & HYU */
...
int	sbsp_bibReview(AcqWorkArea *wk)
{
			...
			elt = sdr_list_next(sdr, elt))
	{
		...
		/*
		 * We need to use eidsMatch() to support wild-carded EIDs,
		 * and with this, line number 1416 should be modified as well,
		 * to enable service-number-specific security rules.
		 */
