...
void dtn_ion_bpadmin_init_ctrl()
{
	...
	adm_add_ctrldef(g_dtn_ion_bpadmin_idx[ADM_CTRL_IDX], DTN_ION_BPADMIN_CTRL_EGRESS_PLAN_OUTDUCT_ATTACH, 3, dtn_ion_bpadmin_ctrl_egress_plan_outduct_attach);	/* ETRI & HYU */
	adm_add_ctrldef(g_dtn_ion_bpadmin_idx[ADM_CTRL_IDX], DTN_ION_BPADMIN_CTRL_EGRESS_PLAN_OUTDUCT_DETACH, 3, dtn_ion_bpadmin_ctrl_egress_plan_outduct_detach);	/* ETRI & HYU */
}
