 ...
 * +---------------------+--------------+--------------------------------------+-------+
 * |start                |44c118b509    |This control starts link service outpu|       |
 * |                     |              |t tasks for all LTP spans (to remote e|       |
 * |                     |              |ngines) from the local LTP engine, and|       | <<< ADDED
 * |                     |              |it starts the link service input task |       | (ETRI & HYU)
...
#define DTN_ION_LTPADMIN_CTRL_START 0x09	/* ETRI & HYU */
